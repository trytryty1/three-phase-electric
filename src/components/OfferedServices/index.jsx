        ...
        <div className="px-6 pb-8 pt-10 sm:pb-12 flex justify-center">
          <div className="mx-auto w-full lg:mx-0 flex justify-center flex-col">
            ...
            <h2 className="mt-24 text-4xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">
              Offered Services in Clarksville
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              We're commited to helping our customers every step of the way with
              three residentail or commercial electrical projects and providing
              useful services to take care of all their needs read below to
